...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'officina-hub'),
        ...
        'source' => [
            'files' => [
                ...
                'include' => [
                    base_path(),
                    storage_path('app/allegati'),
                    storage_path('app/fatturapa'),
                ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFY_EMAIL') ?: env('MAIL_FROM_ADDRESS') ?: 'admin@officinahub.local',
